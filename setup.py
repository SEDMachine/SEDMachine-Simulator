...
setup(
    ...
    package_data = {'':['VERSION','README.md','LICENCE'],'SEDspec2':['*.npy','*.dat','Data/*.txt','Data/*.TXT','Data/*.dat','Data/*.npy']},
    version = "0.3.0",
    ...
    test_suite = 'Tests',
    entry_points = {
        'console_scripts' : ['SEDMsim = SEDMachine.Simulator:run', 'SEDMsetup = SEDTools.setup:setup'],
    },
)
